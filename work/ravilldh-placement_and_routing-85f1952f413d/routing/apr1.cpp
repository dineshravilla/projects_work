...
//    cout << grid[x1][y1];
	...
	for(int i = 0; i < CCS.size(); i++) {
	    cout << "ccs " << i << endl; //<< ":" << CCS[i].x << "," << CCS[i].y << endl;	
	...
	if(NCS.size() == 0) {
	    ...
	    if(m == 1) {
 	        for(int i = 0; i < m1.size(); i++) {
	          ...
	          //  if(vert == 1) {
//			cout << " NCS 0; vert = 1; grid coord: (" << grid[m1[i].x+1][m1[i].y] << "); ";     
//			cout << " NCS 0; vert = 1; grid coord: (" << grid[m1[i].x-1][m1[i].y] << "); " << endl; 
		...
		//	}
		  ...
		  //  else {
//			cout << " NCS 0; vert = 0; grid coord: (" << grid[m1[i].x+1][m1[i].y] << "); ";     
//			cout << " NCS 0; vert = 0; grid coord: (" << grid[m1[i].x-1][m1[i].y] << "); " << endl;     						    
...
//    cout << grows << gcols;
	...
	int m;
	// Lee Algorithm
	cout << "LEE STARTS " << endl;
	if(Lee_Algorithm(xsrc, ysrc, xtgt, ytgt, 1, grid)) {
	    cout << "Source:" << source << "; Target:" << target << endl;
	    nets[i][4] = 1;
    	    cout << "(" << metal1[0].xbot << "," << metal1[0].ybot << "); (" << metal1[0].xtop << "," << metal1[0].ytop << ")" << endl;
	    print_grid(gcols, grows, grid);	    
	}
    } 
